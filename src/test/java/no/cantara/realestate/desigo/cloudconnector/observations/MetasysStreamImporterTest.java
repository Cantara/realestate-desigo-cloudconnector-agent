...
import no.cantara.realestate.desigo.cloudconnector.automationserver.UserToken;
import no.cantara.realestate.desigo.cloudconnector.automationserver.stream.*;
...
class MetasysStreamImporterTest {
    ...
    private DesigoStreamClient metasysStreamClient;
    ...
    @BeforeEach
    void setUp() {
        metasysStreamClient = mock(DesigoStreamClient.class);
